<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Main.Master" CodeBehind="ConfiguracionSistemaOp8.aspx.vb" Inherits="Presentacion.ConfiguracionSistemaOp8" %>
				...
				<div class="stat-panel">
					<div class="stat-row">
						<div class="stat-cell col-sm-3 padding-sm-hr no-border-r valign-top bg-panel">
							...
							<ul class="list-group no-margin">
                                ...
                                <li class="list-group-item no-border-hr padding-xs-hr no-bg">
                                	...
                                	<li class="list-group-item no-border-hr padding-xs-hr no-bg">
									<a href="#" style="font-size:14px"><strong><i class="fa fa-lightbulb-o text-primary"></i>&nbsp;&nbsp;&nbsp; 
									ETAPAS CONSTRUCTIVAS</strong></a> 
								</li>
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <h4><strong><i class="fa fa-lightbulb-o text-primary"></i>&nbsp;&nbsp;ETAPAS CONSTRUCTIVAS</strong></h4>
                              ...
                              <div class="col-sm-8">
								...
								<div class="form-group no-margin-hr">
									          <select class="form-control input-sm">
                                                   ...
                                                   <option value="">Proyecto 4</option> 
                                                   <option value="">Proyecto 5</option> 
                                                   <option value="">Proyecto 6</option> 
						                      </select>                                                  
                                </div>
							 </div>  
                                <div class="col-md-8">
                                    <label class="control-label">Edita Etapas Constructivas</label>
                                    <dx:ASPxGridView
                            id="grdDetalle"
                            runat="server"
                            theme="Default"
                            ...
                            <Columns>
                            <dx:GridViewDataCheckColumn width="180" Caption= "Código" FieldName="codigo" Name="codigo" VisibleIndex="1">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                            <CellStyle CssClass="claseTestCelda" />
                            </dx:GridViewDataCheckColumn>

                            <dx:GridViewDataTextColumn width="298" Caption="Nombre Etapa Constructiva" FieldName="nec" Name="nec" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
