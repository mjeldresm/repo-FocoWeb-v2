<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Main.Master" CodeBehind="ConfiguracionSistemaOp1.aspx.vb" Inherits="Presentacion.ConfiguracionSistemaOp1" %>
				...
				<div class="stat-panel">
					<div class="stat-row">
						<div class="stat-cell col-sm-3 padding-sm-hr no-border-r valign-top bg-panel">
							...
							<ul class="list-group no-margin">
								...
								<li class="list-group-item no-border-hr padding-xs-hr no-bg">
									<a href="#" style="font-size:14px"><strong><i class="fa fa-gear text-primary"></i>&nbsp;&nbsp; 
									PROYECTOS</strong></a> 
								</li>
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <h4><strong><i class="fa fa fa-gear text-primary"></i>&nbsp;&nbsp;PROYECTOS</strong></h4>
                            <p>En esta sección puedes editar la información relacionada con tus proyectos en Foco.</p><hr />
							<div class="panel-body bg-panel">
                                        <label class="control-label">Edita tus Proyectos</label>
                                <dx:ASPxGridView
                            id="grdDetalle"
                            runat="server"
                            theme="Default"
                            ...
                            <Columns>
                            <dx:GridViewDataCheckColumn width="122" Caption= "Nombre Proyecto" FieldName="proyecto" Name="proyecto" VisibleIndex="1">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                            <CellStyle CssClass="claseTestCelda" />
                            </dx:GridViewDataCheckColumn>

                            <dx:GridViewDataTextColumn width="122" Caption="Código Contable" FieldName="ccontable" Name="ccontable" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                ...
                                <dx:GridViewDataTextColumn width="122" Caption="N° Casas/Deptos" FieldName="casasdeptos" Name="casasdeptos" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn width="122" Caption="M² Construcción" FieldName="m2construccion" Name="m2construccion" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn width="122" Caption="Región" FieldName="region" Name="region" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn width="122" Caption="Ciudad" FieldName="ciudad" Name="ciudad" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn width="122" Caption="Gerente" FieldName="gerente" Name="gerente" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn width="122" Caption="Administrador" FieldName="administrador" Name="administrador" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn width="142" Caption="Inicio Plazo Contract." FieldName="plazocontrac" Name="plazocontrac" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                                ...
                                <dx:GridViewDataTextColumn width="122" Caption="Contrato" FieldName="contrato" Name="contrato" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
