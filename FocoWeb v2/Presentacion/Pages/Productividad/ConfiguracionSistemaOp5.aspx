				...
				<div class="stat-panel">
					<div class="stat-row">
						...
						<div class="stat-cell col-sm-9 padding-sm">
                            ...
                            <h4><strong><i class="fa fa-book text-primary"></i>&nbsp;&nbsp;CARGOS</strong></h4>
                            ...
                            <dx:GridViewDataTextColumn width="298" Caption="Especialidad" FieldName="especialidad" Name="especialidad" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
