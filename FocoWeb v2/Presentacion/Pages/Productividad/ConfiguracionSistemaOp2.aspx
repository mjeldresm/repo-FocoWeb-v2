<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Main.Master" CodeBehind="ConfiguracionSistemaOp2.aspx.vb" Inherits="Presentacion.ConfiguracionSistemaOp2" %>
				...
				<div class="stat-panel">
					<div class="stat-row">
						<div class="stat-cell col-sm-3 padding-sm-hr no-border-r valign-top bg-panel">
							...
							<ul class="list-group no-margin">
								...
								<li class="list-group-item no-border-hr no-border-b padding-xs-hr no-bg">
									<a href="#" style="font-size:14px"><strong><i class="fa fa-map-marker text-primary"></i>&nbsp;&nbsp;&nbsp; 
									UBICACIONES</strong></a> 
								</li>
                                <li class="list-group-item no-border-hr padding-xs-hr no-bg no-border-radius">
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <h4><strong><i class="fa fa-map-marker text-primary"></i>&nbsp;&nbsp;UBICACIONES</strong></h4>
                            <p>En esta sección puedes editar la información relacionada a las ubicaciones de tus proyectos en Foco.</p><hr />
							
                            <div class="panel-body bg-panel">
                            
                            <div class ="col-md-12">
                                 <label class="control-label">Edita Ubicaciones</label>
                            <dx:ASPxGridView
                            id="grdDetalle"
                            runat="server"
                            theme="Default"
                            ...
                            <Columns>
                            <dx:GridViewDataCheckColumn width="180" Caption= "País" FieldName="pais" Name="pais" VisibleIndex="1">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                            <CellStyle CssClass="claseTestCelda" />
                            </dx:GridViewDataCheckColumn>

                            <dx:GridViewDataTextColumn width="240" Caption="Región" FieldName="region" Name="region" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                ...
                                <dx:GridViewDataTextColumn width="309" Caption="Comuna" FieldName="comuna" Name="comuna" VisibleIndex="3">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
                            ...
                            <settings showfilterrow="True" ShowGroupPanel="false" VerticalScrollableHeight="325" HorizontalScrollBarMode="auto" VerticalScrollBarMode="auto" UseFixedTableLayout="true"/>
