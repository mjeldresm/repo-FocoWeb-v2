				...
				<div class="stat-panel">
					<div class="stat-row">
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <dx:GridViewDataTextColumn width="200" Caption="Región" FieldName="region" Name="region" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                ...
                                <dx:GridViewDataTextColumn width="276" Caption="Comuna" FieldName="comuna" Name="comuna" VisibleIndex="3">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                                <cellstyle horizontalalign="Center">
                                </cellstyle>
                                <EditFormSettings Visible="false" />
