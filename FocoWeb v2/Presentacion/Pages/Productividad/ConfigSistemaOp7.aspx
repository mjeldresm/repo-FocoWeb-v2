<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Main.Master" CodeBehind="ConfiguracionSistemaOp7.aspx.vb" Inherits="Presentacion.ConfiguracionSistemaOp7" %>
				...
				<div class="stat-panel">
					<div class="stat-row">
						<%--<div class="stat-cell col-sm-3 padding-sm-hr no-border-r valign-top bg-panel">
							...
							<ul class="list-group no-margin">
                                ...
                                <li class="list-group-item no-border-hr padding-xs-hr no-bg">
                                	...
                                	<li class="list-group-item no-border-hr padding-xs-hr no-bg">
									<a href="#" style="font-size:14px"><strong><i class="fa fa-tachometer text-primary"></i>&nbsp;&nbsp; 
									UNIDADES DE MEDIDA</strong></a> 
								</li>
                                	<li class="list-group-item no-border-hr padding-xs-hr no-bg">
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <h4><strong><i class="fa fa-tachometer text-primary"></i>&nbsp;&nbsp;UNIDADES DE MEDIDA</strong></h4>
                            <p>En esta sección puedes editar la información relacionada con las unidades de medida de tus proyectos en Foco.</p><hr />
							<div class="panel-body bg-panel">
                                       
                            <div class ="col-md-6">
                            <label class="control-label">Edita Unidades de Medida</label>
                            <dx:ASPxGridView
                            id="grdDetalle"
                            runat="server"
                            theme="Default"
                            ...
                            <Columns>
                            <dx:GridViewDataCheckColumn width="137" Caption= "Unidad de Medida" FieldName="umed" Name="umed" VisibleIndex="1">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                            <CellStyle CssClass="claseTestCelda" />
                            </dx:GridViewDataCheckColumn>

                            <dx:GridViewDataTextColumn width="349" Caption="Descripción" FieldName="desc" Name="desc" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
