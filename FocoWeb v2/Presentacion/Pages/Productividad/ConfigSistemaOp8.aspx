				...
				<div class="stat-panel">
					<div class="stat-row">
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <Columns>
                            <dx:GridViewDataCheckColumn width="190" Caption= "Código" FieldName="codigo" Name="codigo" VisibleIndex="1">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
                            <CellStyle CssClass="claseTestCelda" />
                            </dx:GridViewDataCheckColumn>

                            <dx:GridViewDataTextColumn width="466" Caption="Nombre Etapa Constructiva" FieldName="nec" Name="nec" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
