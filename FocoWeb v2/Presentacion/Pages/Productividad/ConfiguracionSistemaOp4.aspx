<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Main.Master" CodeBehind="ConfiguracionSistemaOp4.aspx.vb" Inherits="Presentacion.ConfiguracionSistemaOp4" %>
					...
					<div class="stat-row">
						<div class="stat-cell col-sm-3 padding-sm-hr no-border-r valign-top bg-panel">
							...
							<ul class="list-group no-margin">
								...
								<li class="list-group-item no-border-hr padding-xs-hr no-bg">
									<a href="#" style="font-size:14px"><strong><i class="fa fa-user text-primary"></i>&nbsp;&nbsp;&nbsp; 
									SUPERVISORES</strong></a> 
								</li> 
                                <li class="list-group-item no-border-hr padding-xs-hr no-bg">
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <h4><strong><i class="fa fa-user text-primary"></i>&nbsp;&nbsp;SUPERVISORES</strong></h4>
                            <p>En esta sección puedes editar la información relacionada con los supervisores de tus proyectos en Foco.</p><hr />
                            ...
                            <dx:GridViewDataTextColumn width="298" Caption="Nombre Supervisores" FieldName="nsup" Name="nsup" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
