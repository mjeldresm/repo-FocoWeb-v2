<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master/Main.Master" CodeBehind="ImportaFichas.aspx.vb" Inherits="Presentacion.ImportaFichas" %>
    ...
    <div class="row">
        ...
        <div class="panel">  
                    ...
                    <div class="panel-heading" id="c-tooltips-demo"> 
						...
						<span class="panel-title" style="color:#17649A"><b>IMPORTADOR DE FICHAS</b></span>
                        <div id="datosTop" class="panel-heading-controls" style="display:none">
							 <span class="panel-heading-text">
                                ...
                                &nbsp;&nbsp;
                                 							<button id="modalOpen" class="btn btn-xs btn-info tooltip-info" data-toggle="modal" data-placement="left" title="" data-original-title="Aprende a usar el Importador de Fichas" data-target="#uidemo-modals-alerts-success"> <i class="fa fa-medkit fa-1x" aria-hidden="true" style="color:#f1f1f1"></i>&nbsp;&nbsp ¿NECESITAS AYUDA?</button>
							    	...
							    	<div class="wizard-pane" id="wizard-example-step1">
                                        <div class="row">                                      
                                            <div class="col-md-4" >
                                                 ...
                                                 <h4>Comencemos!</h4>
                                                    <p>Bienvenido al <b>Importador de Fichas</b>. Sigue con atención los pasos de este proceso para que puedas optimizar tus tiempos de trabajo en cuanto al control de Fichas de trabajadores de tu proyecto. <br /><br />Presiona "Ayuda" en la parte superior si necesitas asistencia o no sabes usar esta sección.</p>
                                                      </div>
                                                     </div>
                                                </div>
                                                <div class="col-md-4">
...
<i class="fa fa-arrow-circle-left fa-2x" aria-hidden="true" style="color:#008080"></i>
                                            ...
                                            <div class="col-md-5" style="text-align:right">
                                            <p><a class="wizard-next-step-btn" style="cursor:pointer">Guardar y Continuarasd</a><span class="fa-stack fa-lg wizard-next-step-btn" style="cursor:pointer">
            <i class="fa fa-arrow-circle-right fa-2x" aria-hidden="true" style="color:#008080"></i>
                    </span> </p>
                                            </div>
                                      ...
                                      <div class="wizard-pane" id="wizard-example-step4">
                                          ...
                                          <div class="col-md-2" id="countdown"><h4 style="text-align:center"><strong>No hay observaciones</strong></h4><p style="text-align:center">Prosiga al Paso 4 para completar su resumen.</p></div>
                                          <div class="col-md-5"></div>
                                        </div>
                               <%--<div class="row">
...
<i class="fa fa-arrow-circle-left fa-2x" aria-hidden="true" style="color:#008080"></i>
            ...
            <i class="fa fa-arrow-circle-right fa-2x" aria-hidden="true" style="color:#008080"></i>
					...
					<div class="panel-heading">
						...
						El proceso de importación de fichas ha finalizado exitosamente.
						</div>
					</div> 
					<div class="list-group">
						<a href="#" class="list-group-item"><i class="fa fa-arrow-right list-group-icon"></i>Fichas Encontradas<span class="label label-primary pull-right text-left-md">14123</span></a>
						<a href="#" class="list-group-item"><i class="fa fa-arrow-right list-group-icon"></i>Total Fichas Encontradas<span class="label label-primary pull-right text-left-md">123455</span></a>
    ...
    <div id="uidemo-modals-alerts-success" class="modal modal-alert modal-info fade modal">
					<div class="modal-dialog" style="width:500px;max-height:350px">
						<div class="modal-content">
							...
							<div class="modal-title" style="margin-top:10px"><h4><strong>AYUDA IMPORTADOR DE FICHAS</strong></h4></div>
