				...
				<div class="stat-panel">
					<div class="stat-row">
						<div class="stat-cell col-sm-3 padding-sm-hr no-border-r valign-top bg-panel">
							...
							<ul class="list-group no-margin">
                                ...
                                <li class="list-group-item no-border-hr padding-xs-hr no-bg">
                                	...
                                	<li class="list-group-item no-border-hr padding-xs-hr no-bg">
									<a href="#" style="font-size:14px"><strong><i class="fa fa-flag text-primary"></i>&nbsp;&nbsp; 
									ACTIVIDADES DE CONTROL</strong></a> 
								</li>
                                	<li class="list-group-item no-border-hr padding-xs-hr no-bg">
						...
						<div class="stat-cell col-sm-9 padding-sm ">
                            ...
                            <h4><strong><i class="fa fa-flag text-primary"></i>&nbsp;&nbsp;ACTIVIDADES DE CONTROL</strong></h4>
							...
							<div class="panel-body bg-panel">
                                ...
                                <div class="col-sm-8">
                                      <label class="control-label">Edita Actividades de Control</label>
                                    <dx:ASPxGridView
                            id="grdDetalle"
                            runat="server"
                            theme="Default"
                            ...
                            <dx:GridViewDataTextColumn width="298" Caption="Nombre Actividad de Control" FieldName="nact" Name="nact" VisibleIndex="2">
                            <HeaderStyle HorizontalAlign="Center" CssClass="claseTest" />
