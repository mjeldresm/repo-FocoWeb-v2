                                ...
                                <span class="panel-title">
                                   <%-- <div class="btn-group">
                                        <button type="button" class="btn btn-labeled btn-flat  btn-xs btn-rounded btn-dark-gray">
                                            <span class="btn-label "><i class="glyphicon glyphicon-certificate"></i></span><strong>
                                                <asp:Label CssClass="text-xs" ID="lblAct" runat="server" Text=""></asp:Label></strong>
                                        </button>
                                        &nbsp;&nbsp;
                                                    <button type="button" class="btn btn-labeled btn-flat btn-xs">
                                                        <span class="btn-label"><i class="glyphicon glyphicon glyphicon glyphicon-list-alt"></i></span><strong>
                                                            <asp:Label CssClass="text-xs" ID="lblPlnNom" runat="server" Text=""></asp:Label></strong>
                                                    </button>
                                        &nbsp;&nbsp;
           	                                       <button type="button" class="btn btn-labeled btn-flat btn-xs">
                                                          <span class="btn-label"><i class="glyphicon glyphicon-home"></i></span><strong>
                                                              <asp:Label CssClass="text-xs" ID="lblObra" runat="server" Text=""></asp:Label></strong>
                                                      </button>
                                    </div>--%>
                                </span>
                            </div>
                ...
                <div class="wizard-wrapper">
                    <ul class="wizard-steps">
                        <li data-target="#wizard-example-step1">
                            ...
                            <span class="wizard-step-caption">INFORMACIÓN DE PLANTILLA
                            </span>
                        </li>
                        <li data-target="#wizard-example-step2">
                            <span class="wizard-step-number">2</span>
                            <span class="wizard-step-caption">LISTA DE CHEQUEO
                            </span>
                        </li>
                        <li data-target="#wizard-example-step3">
                            <span class="wizard-step-number">3</span>
                            <span class="wizard-step-caption">PARTICIPANTES
                            </span>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="wizard-pane" id="wizard-example-step1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="panel widget-tasks  panel-transparent ">
                                    ...
                                    <div class="panel-body">
                                        <%-- <span class="text-default "><em>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </em></span>--%>  <%--DataSourceID="sqlObra"--%>
                                        <br />
                                        <br />
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <%--<asp:SqlDataSource ID="sqlObra" runat="server" ConnectionString="<%$ ConnectionStrings:cnxCalidad %>"--%>
                                                        <asp:SqlDataSource ID="sqlObra" runat="server"
                                                            SelectCommand="SELECT [ID_OBR], [NomAbr_Obr] FROM [OBRAS] WHERE ([Vigente_Obr] = @Vigente_Obr)">
                                                            <SelectParameters>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                            <ContentTemplate>
                                                                <dx:BootstrapTextBox ClientInstanceName="codigo" Enabled="false"
                                                                    ID="codigotexto" Caption="Código" runat="server" NullText="Código de plantilla">
                                                                </dx:BootstrapTextBox>
                                                            </ContentTemplate>
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                            <ContentTemplate>
                                                                ...
                                                                <div class="input-group col-sm-12">
                                                                    ...
                                                                    <asp:SqlDataSource ID="sqlActividad" runat="server" SelectCommand="SELECT [NOMBRE_ACT], [ID_QA_ACT], [ID_ETA] FROM [QA_ACTIVIDAD] WHERE ([ID_OBR] = @ID_OBR) ORDER BY  NOMBRE_ACT ASC">
                                                                        <SelectParameters>
                                                                            <asp:SessionParameter Name="ID_OBR" SessionField="idObra" Type="Int64" />
                                                                        </SelectParameters>
                                                                    </asp:SqlDataSource>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-transparent ">
                                    <div class="panel-heading">
                                        <span class="panel-title"><i class="fas fa-map-marker-alt fa-2x"></i><b>1.2) </b>&nbsp;&nbsp; Observaciones Y Alcance de la Plantilla </span>
                                    </div>
                                    <div class="panel-body">
                        ...
                        <Style CssClass="fas fa-angle-double-right fa-2x"></Style>
                                                            ...
                                                            <asp:SqlDataSource ID="sqlCategorias" runat="server"
                                                                SelectCommand="SELECT [ID_TUC], [ID_OBR], [NOMBRE_TUC] FROM [UCO_TIPOS] WHERE ([ID_OBR] = @ID_OBR)  ORDER BY  NOMBRE_TUC ASC  ">
                                                                <SelectParameters>
                                                                    <asp:SessionParameter Name="ID_OBR" SessionField="idObra" Type="Int64" />
                                                                </SelectParameters>
                                                            </asp:SqlDataSource>
                                        ...
                                        <!-- / .form-group -->
                                        <p class="help-block">
                                            ejemplo: Departamento (Categoría) Tipo A (Tipologia).                                                                                                 
                                    </div>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <dx:ASPxGridView ID="grillaCheck" runat="server" AutoGenerateColumns="False" DataSourceID="sqlListaCheck" KeyFieldName="ID_PLT_CHK" EnableTheming="True" Theme="MaterialCompact" Width="100%">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="CRITERIO" FieldName="CRITERIO_CONTROL" VisibleIndex="8" Width="10%" AllowTextTruncationInAdaptiveMode="True" FixedStyle="Left">
                                                            <SettingsHeaderFilter>
                                                                <DateRangeCalendarSettings>
                                                                    <FastNavProperties DisplayMode="Inline" />
                                                                </DateRangeCalendarSettings>
                                                        ...
                                                        <dx:GridViewDataMemoColumn Caption="ESPECIFICACIÓN" FieldName="ESPECIFICACION_CHK" VisibleIndex="7" Width="45%">
                    ...
                    <div class="wizard-pane" id="wizard-example-step3" <%--style="display: none;"--%>>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-transparent">
                                    <div class="panel-heading">
                                        <span class="panel-title "><i class="lnr lnr-sort-amount-asc fa-2x "></i><b>3.1)</b>&nbsp;&nbsp;Definición de cadena revisión</span>
                                    </div>
                                    <div class="panel-body">
                        ...
                        <Style CssClass="fas fa-angle-double-right fa-2x"></Style>
                                        ...
                                        <asp:SqlDataSource ID="SqlUsuarios" runat="server"
                                            SelectCommand="SELECT [id_Usu], [nombre_Usu] FROM [USUARIOS]"></asp:SqlDataSource>
...
ORDER BY [ID_PLT_VB] DESC">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-transparent">
                                    <div class="panel-heading">
                                        <span class="panel-title "><i class="lnr lnr-apartment fa-2x"></i><b>3.2)</b>&nbsp;&nbsp;Definición de mensajería </span>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <dx:ASPxGridView ID="gridMensajes" runat="server" DataSourceID="SqlDataSource2" EnableTheming="True" Theme="MaterialCompact" AutoGenerateColumns="False" KeyFieldName="ID_QA_MSG" Width="100%">
                                            <Columns>
                                                ...
                                                <dx:GridViewBandColumn ShowInCustomizationForm="True" Caption="MENSAJERIA - DEFINICIÓN DE DESTINATARIOS DE AVISOS.-" VisibleIndex="1">
                                                    <Columns>
                                                        <dx:GridViewDataTextColumn FieldName="NOMBRE_MSG" ShowInCustomizationForm="True" Width="15%" Caption="NOMBRE" VisibleIndex="2"></dx:GridViewDataTextColumn>
                                                        ...
                                                        <dx:GridViewDataTextColumn FieldName="MAIL_MSG" ShowInCustomizationForm="True" Width="15%" Caption="E-MAIL" VisibleIndex="4"></dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn FieldName="FONO_MSG" ShowInCustomizationForm="True" Width="15%" Caption="TELEFONO" VisibleIndex="5"></dx:GridViewDataTextColumn>
                                                    </Columns>
                                                </dx:GridViewBandColumn>
                                            </Columns>
                                            <SettingsEditing Mode="Inline">
    ...
    <script>
         $(document).ready(function () {
             ...
             $("#body_GuardarPaso_1").click(function () {
                 ...
                 var idAct = $('#body_dllActividad_I').val();
                 var obs = $('#body_txtMemPbservaciones_I').val();
                 var datos = "{'':'" + + "','codPlt':'" + codPlt + "','nomPlt':'" + nomPlt + "','idAct':'" + idAct + "','obs':'" + obs + "' }";
         ...
         $("#wizard-example-step3").click(function () {
