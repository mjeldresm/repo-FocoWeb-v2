...
<asp:Content ID="MainBody" ContentPlaceHolderID="body" runat="server">
    ...
    <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" ClientIDMode="AutoID" DataSourceID="SqlDataSource1" Theme="MaterialCompact" Height="100%" Width="100%">
        <Fields>
            <dx:PivotGridField FieldName="NOMBRE_UCO" ID="fieldNOMBREUCO" Area="RowArea" AreaIndex="0"></dx:PivotGridField>
            <dx:PivotGridField FieldName="UCO_SUP" ID="fieldUCOSUP" Area="DataArea" AreaIndex="0"></dx:PivotGridField>
            <dx:PivotGridField FieldName="NOMBRE_TIP" ID="fieldNOMBRETIP" Area="RowArea" AreaIndex="1"></dx:PivotGridField>
            <dx:PivotGridField ID="fieldTIPOUCO" Area="ColumnArea" AreaIndex="0" FieldName="TIPOUCO">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldIDTIP" Area="DataArea" FieldName="ID_TIP" Visible="False">
            </dx:PivotGridField>
            <dx:PivotGridField ID="fieldIDTUC" Area="DataArea" FieldName="ID_TUC" Visible="False">
            </dx:PivotGridField>
        </Fields>
    </dx:ASPxPivotGrid>
