...
Namespace Seguridad
    Public Class Usuario
        ...
        Public Shared Function Ingresar(vUsuario As String, vPassword As String, vStrConexion As String,
            ...
            End If
        End Function
        Public Shared Function RecuperarClave(usuCorreo As String, vStrConexion As String) As DataSet
            ...
            Dim vEnc As New Encriptacion
            With vParam
                .Add("@USUARIOCORREO", usuCorreo)
            End With
            Try
                vTablas = vCon.ExecSP_DS("SP_RECUPERAR_PASSWORD", vParam)
        ...
        End Function
        Public Shared Function NotificarRecup(id_Usu As String, vStrConexion As String) As DataSet
            ...
            End With
            Try
                vTablas = vCon.ExecSP_DS("SP_NOTIFICAR_CAMBIO_PASS", vParam)
            ...
            Catch ex As SqlException
                ...
                End If
            Catch ex As Exception
                Throw New Exception("No se ha podido enviar la notificacion.", ex)
            End Try
        ...
        Public Shared Function CambiarPass(vUsuario As String,
            ...
            Try
                datos = vCon.ExecSPOut("SP_WEB_CAMBIO_PASS_REC", vParam, vParamOut, Nothing, 90)
            ...
            If datos IsNot Nothing Then Return True
            Return False
        End Function
